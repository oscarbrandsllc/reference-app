...
function buildCharts() {
  ...
  const starterCanvas = document.getElementById("startersChart");
  starterCanvas.height = Math.max(teams.length * 40, 200);
  const ctx1 = starterCanvas.getContext("2d");
  ...
  totalCanvas.height = Math.max(teams.length * 40, 200);
  const ctx2 = totalCanvas.getContext("2d");
